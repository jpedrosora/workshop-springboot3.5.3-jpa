...
import com.project1.course.entities.Payment;
...
import com.project1.course.repositories.OrderItemRepository;
...
//injeção de dependencia automatica feita pelo container do framework
	// annotation que resolve a dependencia associa uma instancia, quando um servico
	// depende de outro a injeção deve ser fraca
	@Autowired
	...
	public void run(String... args) throws Exception {
		...
		//pra salvar um objeto dependente em uma relação 1 pra 1, nao chamamos o repository do proprio objeto
